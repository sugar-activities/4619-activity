...
class ZeroInstallFeed(object):
	...
	def get_package_impls(self, distro, pkg_type=None):
		...
		if pkg_type is None:
			from sugar_network.zerosugar.local import hooks
			pkg_type = hooks.pkg_type
		...
		if not best_impls and pkg_type == 'devel':
			return self.get_package_impls(distro, 'runtime')
		else:
			return best_impls
